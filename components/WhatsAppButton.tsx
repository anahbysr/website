export default function WhatsAppButton({ whatsappNumber }: { whatsappNumber: string }) {
  const message = encodeURIComponent("Hi Anah, I'd like to know more about your collection.");
  return (
    <a
